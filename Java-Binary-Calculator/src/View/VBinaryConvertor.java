...
import Model.MBinaryConvertor;

/**
 *
 * @author test
 */
public class VBinaryConvertor extends javax.swing.JFrame {

    /**
     * Creates new form MainWindow
     */
    public VBinaryConvertor() {
        initComponents();
    }
    ...
    private void btn1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn1ActionPerformed
        ...
        try{
            MBinaryConvertor obj = new MBinaryConvertor();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VBinaryConvertor.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new VBinaryConvertor().setVisible(true);
            }
        });
    }
